...
def predict1(enc_file, dec_file, out_file):
    pars = {
        'with_tblog': False,
        'enc_file': enc_file,
        'dec_file': dec_file,
...
def predict(file_prefix, out_file):
    pars = {
        'with_tblog': False,
...
if __name__ == '__main__':
    ...
    file_prefix = '../clf/kdd_2018-05-04_21-11-58-248372_430'
    predict(file_prefix, '../submit/test_submit.csv')
    exit()
